...
class Distribution(Distribution_parse_config_files, _Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'features' **deprecated** -- a dictionary mapping option names to
        ...
        from all setup commands, including source and binary distribushunz, so
        you can create multiple distribushunz from the same source tree.
...
class Feature:
    ...
    **deprecated** -- The `Feature` facility was never completely implemented
    ...
    Aside from the methods, the only feature attributes that distribushunz look
