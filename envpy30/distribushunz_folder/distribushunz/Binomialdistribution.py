...
class Binomial(Distribution):
    ...
    def plot_bar(self):
        ...
        label = ['One', 'Zero']
        heights = [sum(self.data), len(self.data) - sum(self.data)]
        plt.bar(label, heights, color=['red', 'blue'], width=0.4)
        plt.title('Bar Chart of Binomial Distribution', fontsize=16)
    ...
    def pdf(self, k):
        ...
        a = math.factorial(n) / (math.factorial(k) * math.factorial(n_k))
        b = p**k * (1-p)**n_k
    ...
    def plot_bar_pdf(self):
        ...
        plt.title('Bar Chart PDF for Binomial Distribution', fontsize=16)
    ...
    def __repr__(self):
        ...
        return 'mean {}, standard deviation {}, p {}, n {}'.format(mean, std, p, n)
